...
sleep(1);
echo '> Input awalan STRING ('.$__imei.'): ';
$input = fopen("php://stdin","r");
$answer = trim(fgets($input));
if($answer!=='') {
	$__imei=$answer;
...
sleep(1);
echo '> Input panjang random STRING ('.$__length.'): ';
$input = fopen("php://stdin","r");
$answer = trim(fgets($input));
if($answer!=='') {
	$__length=(int)$answer;
...
echo '[x] Awalan STRING: ' . $__imei . PHP_EOL;
echo '[x] Panjang random STRING: ' . $__length . PHP_EOL;
